...
This script collects the necessary classes and functions for the computation of the 
HNL production and decay rates 

Note that it was directly copied from the HNLsGen framework
