...
version_label = 'categories_selection_19Aug21_fulllumi_combineddsa'

# path to datacards # Note that it will get /<year>/<channel> appended
#path_to_datacards = '/t3home/anlyon/BHNL/BHNLAnalyser/CMSSW_10_2_15/src/BHNLAnalyser/datacards/categories_selection_19Aug21_fulllumi_combineddsa'
path_to_datacards = '/t3home/anlyon/BHNL/BHNLAnalyser/CMSSW_10_2_15/src/HiggsAnalysis/CombinedLimit/BHNLAnalyser/datacards/categories_selection_19Aug21_fulllumi_combineddsa'
...
datacard_wildcard = 'datacard_bhnl*.txt' 
...
if do_produceLimits:
  ...
  #pathToResults = path_to_datacards
  #print pathToResults
  fileName = 'datacard_combined_*.txt'
  ...
  for mass in masses:
    ...
    for limitFile in files:
      ...
      #if mass == '1': coupling = '5p3em05'
      #elif mass == '3': coupling = '1p2em05'
      #elif mass == '4.5': coupling = '2p4em04' 
