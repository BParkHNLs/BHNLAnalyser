...
if __name__ == "__main__":
        ...
        command = 'combine -M AsymptoticLimits datacards_combined/{v}/datacard_combined_m_{m}_v2_{c}.txt'.format(v=opt.version, m=mass, c=coupling)
        #command = 'combine -M AsymptoticLimits /t3home/anlyon/BHNL/BHNLAnalyser/CMSSW_10_2_15/src/BHNLAnalyser/datacards/{v}/datacard_bhnl_m_{m}_v2_{c}.txt'.format(v=opt.version, m=mass, c=coupling)
        if opt.run_blind:
          command += ' --run blind'
